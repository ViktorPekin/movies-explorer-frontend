      ...
      <main className="profile__container container">
        ...
        <form onSubmit={handleSubmit} className="profile__form">
          ...
          <div className="profile__submit-container">
            <p
              className={
                props.errorServer ? "profile__error_active" : "profile__error"
              }
            >
              {props.errorServer}
            </p>
            <p
              className={
                props.profileInfo ? "profile__info_active" : "profile__info"
              }
            >
              {props.profileInfo}
            </p>
            <button
              className={
                valid ? "profile__form-button" : "profile__form-button_disabled"
              }
              disabled={!valid}
            >
              Редактировать
